...
-- Records of resource
-- ----------------------------
INSERT INTO `resource` VALUES ('1', '权限管理', '', '', '系统管理', 'glyphicon-folder-open ', null, '0', '0', '1', '0', '2014-02-19 01:00:00');
...
INSERT INTO `resource` VALUES ('221', '日志监控', '', '', null, 'glyphicon-dashboard ', null, '3', '0', '0', '0', '2015-12-01 11:44:20');
INSERT INTO `resource` VALUES ('222', '视频教程', '', '', null, 'glyphicon-film ', null, '2', '0', '0', '0', '2015-12-06 12:40:42');
INSERT INTO `resource` VALUES ('223', '官方网站', 'https://www.dreamlu.net', 'iframe', null, 'glyphicon-globe ', '222', '0', '0', '1', '0', '2015-12-06 12:42:42');
INSERT INTO `resource` VALUES ('224', 'jfinal视频', 'http://blog.dreamlu.net/blog/79', 'iframe', null, 'glyphicon-blackboard ', '222', '1', '0', '1', '0', '2015-12-06 12:45:28');
INSERT INTO `resource` VALUES ('226', '修改密码', '/user/editPwdPage', 'ajax', null, 'glyphicon-eye-close ', null, '4', '0', '1', '1', '2015-12-07 20:23:06');
...
INSERT INTO `resource` VALUES ('229', '系统图标', '/icons.html', 'ajax', null, 'glyphicon-picture ', '221', '0', '0', '1', '0', '2016-12-24 15:53:47');
INSERT INTO `resource` VALUES ('230', '文章管理', '', 'ajax', null, 'glyphicon-duplicate ', null, '1', '0', '0', '0', '2016-12-24 15:53:47');
INSERT INTO `resource` VALUES ('231', '新建文章', '/article/create', 'ajax', null, 'glyphicon-open-file ', '230', '0', '0', '1', '0', '2016-12-24 15:53:47');
...
CREATE TABLE `sys_log` (
  ...
  `create_time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=397 DEFAULT CHARSET=utf8 COMMENT='系统日志';

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('391', 'admin', 'admin', '[类名]:com.wangzhixuan.controller.ResourceController,[方法]:editPage,[参数]:id=11&_=1521101111235&', '0:0:0:0:0:0:0:1', '2018-03-15 16:05:31');
INSERT INTO `sys_log` VALUES ('392', 'admin', 'admin', '[类名]:com.wangzhixuan.controller.RoleController,[方法]:grantPage,[参数]:id=1&_=1521101111238&', '0:0:0:0:0:0:0:1', '2018-03-15 16:06:15');
INSERT INTO `sys_log` VALUES ('393', 'admin', 'admin', '[类名]:com.wangzhixuan.controller.RoleController,[方法]:editPage,[参数]:id=1&_=1521101111239&', '0:0:0:0:0:0:0:1', '2018-03-15 16:06:35');
INSERT INTO `sys_log` VALUES ('394', 'admin', 'admin', '[类名]:com.wangzhixuan.controller.RoleController,[方法]:grantPage,[参数]:id=1&_=1521101111240&', '0:0:0:0:0:0:0:1', '2018-03-15 16:06:38');
INSERT INTO `sys_log` VALUES ('395', 'admin', 'admin', '[类名]:com.wangzhixuan.controller.OrganizationController,[方法]:editPage,[参数]:id=3&_=1521101111244&', '0:0:0:0:0:0:0:1', '2018-03-15 16:07:08');
INSERT INTO `sys_log` VALUES ('396', 'admin', 'admin', '[类名]:com.wangzhixuan.controller.ResourceController,[方法]:addPage,[参数]:', null, '2018-03-15 16:11:01');
